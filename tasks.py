...
class SST2Dataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_from_disk("./datasets/sst2")
        train_d = d["train"]
...
class CopaDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_from_disk("./datasets/copa")
...
class BoolQDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_from_disk("./datasets/boolq")
        train_set = d["train"]
...
class MultiRCDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_from_disk("./datasets/multirc")
        train_set = d["train"]
        valid_set = d["validation"]
...
class ReCoRDDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_from_disk("./datasets/record")
        train_set = d["train"]
        valid_set = d["validation"]
...
class DROPDataset(Dataset):
    ...
    def load_dataset(self):
        dataset = load_from_disk("./datasets/drop")
        train_examples = dataset["train"]
        valid_examples = dataset["validation"]
